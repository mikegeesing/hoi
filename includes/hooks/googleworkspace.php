...
function googleworkspace_products_hook($vars) {
   ...
   return array("googleworkspaceproducts" => $decodedata);
}

add_hook("ClientAreaPage", 1, "googleworkspace_products_hook");
