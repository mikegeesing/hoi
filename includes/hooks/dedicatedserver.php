...
function dedicated_products_hook($vars) {
   ...
   return array("dedicatedproducts" => $decodedata);
}

add_hook("ClientAreaPage", 1, "dedicated_products_hook");
