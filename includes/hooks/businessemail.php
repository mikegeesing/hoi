...
function businessemail_products_hook($vars) {
   ...
   return array("businessemailproducts" => $decodedata);
}

add_hook("ClientAreaPage", 1, "businessemail_products_hook");
