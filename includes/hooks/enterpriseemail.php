...
function enterpriseemail_products_hook($vars) {
   ...
   return array("enterpriseemailproducts" => $decodedata);
}

add_hook("ClientAreaPage", 1, "enterpriseemail_products_hook");
