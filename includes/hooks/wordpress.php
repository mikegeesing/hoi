...
function wordpress_products_hook($vars) {
   ...
   return array("wprdpressroducts" => $decodedata);
}

add_hook("ClientAreaPage", 1, "wordpress_products_hook");
