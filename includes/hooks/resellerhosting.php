...
function resellerhosting_products_hook($vars) {
   ...
   return array("resellerhosting" => $decodedata);
}

add_hook("ClientAreaPage", 2, "resellerhosting_products_hook");
