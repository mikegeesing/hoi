    ...
    <div class="collapse show">
        ...
        <div class="form-group p-t-3x" >
            <label class="form-label">
                ...
                {if isset($tooltips.settings.order_process.product_package_settings.package_price.title)}
                    {if isset($tooltips.settings.order_process.product_package_settings.package_price.url) && $tooltips.settings.order_process.product_package_settings.package_price.url != ""}
                        {assign var="popoverFooter" value="<a class='btn btn--secondary btn--xs' href='{$tooltips.settings.order_process.product_package_settings.package_price.url}' target='_blank'>Learn More</a>"}
                    {else}
                    ...
                    {include 
                        ...
                        popoverBody="{$tooltips.settings.order_process.product_package_settings.package_price.title}"
