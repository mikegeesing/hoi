<div class="panel panel--collapse">
    <div class="collapse-toggle">
        <h6 class="top__title">
            ...
            {if isset($tooltips.settings.general.free_product_price.title)}
                {if isset($tooltips.settings.general.free_product_price.url) && $tooltips.settings.general.free_product_price.url != ""}
                    {assign var="popoverFooter" value="<a class='btn btn--secondary btn--xs' href='{$tooltips.settings.general.free_product_price.url}' target='_blank'>Learn More</a>"}
                {else}
                ...
                {include 
                    ...
                    popoverBody="{$tooltips.settings.general.free_product_price.title}"
