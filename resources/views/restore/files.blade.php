                                    ...
                                    <div class="flex items-center gap-3">
                                        <div class="flex-shrink-0">
                                            ...
                                            @else
                                                ...
                                                @elseif(in_array($ext, ['zip', 'tar', 'gz', 'rar', '7z', 'bz2']))
                                                    <!-- Archive file -->
                                                ...
                                                @elseif(in_array($ext, ['sql', 'db', 'sqlite']))
                                                    <!-- Database file -->
