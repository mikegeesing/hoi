    ...
    {if $templatefile == 'homepage'}
        {include file="$template/includes/tt/hostlar/tt-cta.tpl"}
    {/if}
                       ...
                       <div class="tt-footer-widget">
                           <h6 class="text-white">Our Products</h6>
                            <ul class="list-unstyled tt-footer-menu mt-3">
                                ...
                                <li><a href="{$WEB_ROOT}/store/store/dedicated-hosting">Dedicated Hosting</a></li>
                   ...
                   <div class="col-lg-3 col-md-6">
                       <div class="tt-footer-widget">
                           ...
                           <ul class="list-unstyled tt-footer-menu mt-3">
                               ...
                               <li><a href="{$WEB_ROOT}/store/email-services">E-mail Services</a></li>
                               <li><a href="{$WEB_ROOT}/store/site-builder">Site Builder</a></li>
                               <li><a href="{$WEB_ROOT}/store/website-builder">Weebly Website Builder</a></li>
                               <li><a href="{$WEB_ROOT}/store/cpanelseo">cPanel SEO</a></li>
                           </ul>
                       </div>
                   </div>
                   <div class="col-lg-3 col-md-6">
                       <div class="tt-footer-widget">
                           ...
                           <img src="{$WEB_ROOT}/templates/{$template}/img/icon-payments.png" class="img-fluid mt-3" alt="support image">
                       </div>
                   </div>
               </div>
            </div>
