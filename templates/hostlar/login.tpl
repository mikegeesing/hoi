    ...
    <form method="post" action="{routePath('login-validate')}" class="login-form" role="form">
        <div class="tt-form-container">
            <div class="tt-form-content">
                ...
                <div class="form-group mb-4 focused">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="mb-2">
                            <a href="{routePath('password-reset-begin')}" class="small text-muted" tabindex="-1">{lang
                                key='forgotpw'}</a>
                        </div>
                    </div>
                    <div class="input-group input-group-merge">
                ...
                {include file="$template/includes/tt/hostlar/tt-captcha.tpl"}
                {/if}
                <div class="d-flex align-items-center justify-content-between">
            ...
            <div class="tt-login-registration-testimonial"
                style="background: url('{$WEB_ROOT}/templates/{$template}/img/tt-login-testimonial-bg.jpg')no-repeat center bottom / cover">
                <div class="tt-testimonial-slider">
                    {include file="$template/includes/tt/hostlar/tt-login-register-testimonial.tpl"}
                </div>
            </div>
        </div>
    </form>
