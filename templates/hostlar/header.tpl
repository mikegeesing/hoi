...
<body class="tt-body-wrapper {if $templatefile == 'homepage'}primary-bg-color bg-gray-light{/if}" data-phone-cc-input="{$phoneNumberInputStyle}">
{if $captcha}{$captcha->getMarkup()}{/if}
{$headeroutput}

{include file="$template/includes/tt/hostlar/tt-homepage.tpl"}
