                ...
                <div class="panel-body panel-domain-option">
                    <div class="content">
                        ...
                        {if $registerdomainenabled}
                            <label class="radio">
                                <input type="radio" class="icheck-control" {if ($smarty.get.domain && $smarty.get.domain == "register") || $domainoption eq "register"}checked{/if} name="domainoption" value="register" id="selregister" /><span>{$LANG.cartregisterdomainchoice|sprintf2:$companyname}</span>
                            </label>
                        {/if}
                        {if $transferdomainenabled}
                            <label class="radio">
                                <input type="radio" class="icheck-control" {if ($smarty.get.domain && $smarty.get.domain == "transfer") || $domainoption eq "transfer"}checked{/if} name="domainoption" value="transfer" id="seltransfer" /><span>{$LANG.carttransferdomainchoice|sprintf2:$companyname}</span>
                            </label>
                        {/if}
                        {if $owndomainenabled}
                            <label class="radio">
                                <input type="radio" class="icheck-control" {if ($smarty.get.domain && $smarty.get.domain == "owndomain") || $domainoption eq "owndomain"}checked{/if} name="domainoption" value="owndomain" id="selowndomain" /><span>{$LANG.cartexistingdomainchoice|sprintf2:$companyname}</span>
                            </label>
                        {/if}
                        {if $subdomains}
                            <label class="radio">
                                <input type="radio" class="icheck-control" {if $domainoption eq "subdomain"} checked{/if} name="domainoption" value="subdomain" id="selsubdomain" /><span>{$LANG.cartsubdomainchoice|sprintf2:$companyname}</span>
                            </label>
                        {/if}
                    </div>
                </div>
