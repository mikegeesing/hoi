                                                    ...
                                                    {else}
                                                        ...
                                                        {if isset($RSThemes['addonSettings']['price_calculation']) && $RSThemes['addonSettings']['price_calculation'] == "lowest"}
                                                            ...
                                                            {else}       
                                                                ...
                                                                {if $productsPricing[$product.pid]->cycle == "onetime"}
                                                                    {$productPrice = formatCurrency($productsPricing[$product.pid]->tabs[$productsPricing[$product.pid]->cycle]['price'])}
                                                                {else}
                                                                    {$productPrice = formatCurrency($productsPricing[$product.pid]->tabs[$productsPricing[$product.pid]->cycle]['real_price'])}
                                                                {/if}
                                                                {include file="$template/includes/common/price.tpl" 
                                                                    price=$productPrice
