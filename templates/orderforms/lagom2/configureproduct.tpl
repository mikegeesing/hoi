        ...
        <div class="main-grid{if $mainGrid} {$mainGrid}{/if}">
                                                            ...
                                                            {else}
                                                                {if ($DiscountCenterAddonIsActive)}
                                                                    ...
                                                                    {if isset($RSThemes['addonSettings']['product_domain_free_price']) && $RSThemes['addonSettings']['product_domain_free_price'] == 'true'}
                                                                        {if $pricing.cycles.monthly|strstr:$LANG.orderfreedomainonly && $freeDomainAssignedToProduct}{$freeDomainMonthly = true}{/if}
                                                                    {else}
                                                                ...
                                                                {else}
                                                                    {if isset($RSThemes['addonSettings']['product_domain_free_price']) && $RSThemes['addonSettings']['product_domain_free_price'] == 'true'}
                                                                        {if $pricing.monthly|strstr:$LANG.orderfreedomainonly && $freeDomainAssignedToProduct}{$freeDomainMonthly = true}{/if}
                                                                    {else}
                                                        ...
                                                        <h6 class="check-title">
                                                            ...
                                                            {else}
                                                                {if ($DiscountCenterAddonIsActive)}
                                                                    ...
                                                                    {if isset($RSThemes['addonSettings']['product_domain_free_price']) && $RSThemes['addonSettings']['product_domain_free_price'] == 'true'}
                                                                        {if $pricing.cycles.quarterly|strstr:$LANG.orderfreedomainonly && $freeDomainAssignedToProduct}{$freeDomainQuarterly = true}{/if}
                                                                    {else}
                                                                ...
                                                                {else}
                                                                    {if isset($RSThemes['addonSettings']['product_domain_free_price']) && $RSThemes['addonSettings']['product_domain_free_price'] == 'true'}
                                                                        {if $pricing.quarterly|strstr:$LANG.orderfreedomainonly && $freeDomainAssignedToProduct}{$freeDomainQuarterly = true}{/if}
                                                                    {else}
                                                        ...
                                                        <h6 class="check-title">
                                                            ...
                                                            {else}
                                                                {if ($DiscountCenterAddonIsActive)}
                                                                    ...
                                                                    {if isset($RSThemes['addonSettings']['product_domain_free_price']) && $RSThemes['addonSettings']['product_domain_free_price'] == 'true'}
                                                                        {if $pricing.cycles.semiannually|strstr:$LANG.orderfreedomainonly && $freeDomainAssignedToProduct}{$freeDomainSemiAnnually = true}{/if}
                                                                    {else}
                                                                ...
                                                                {else}
                                                                    {if isset($RSThemes['addonSettings']['product_domain_free_price']) && $RSThemes['addonSettings']['product_domain_free_price'] == 'true'}
                                                                        {if $pricing.semiannually|strstr:$LANG.orderfreedomainonly && $freeDomainAssignedToProduct}{$freeDomainSemiAnnually = true}{/if}
                                                                    {else}
                                                        ...
                                                        <h6 class="check-title">
                                                            ...
                                                            {else}
                                                                {if ($DiscountCenterAddonIsActive)}
                                                                    ...
                                                                    {if isset($RSThemes['addonSettings']['product_domain_free_price']) && $RSThemes['addonSettings']['product_domain_free_price'] == 'true'}
                                                                        {if $pricing.cycles.annually|strstr:$LANG.orderfreedomainonly && $freeDomainAssignedToProduct}{$freeDomainAnnually = true}{/if}
                                                                    {else}
                                                                ...
                                                                {else}
                                                                    {if isset($RSThemes['addonSettings']['product_domain_free_price']) && $RSThemes['addonSettings']['product_domain_free_price'] == 'true'}
                                                                        {if $pricing.annually|strstr:$LANG.orderfreedomainonly && $freeDomainAssignedToProduct}{$freeDomainAnnually = true}{/if}
                                                                    {else}
                                                        ...
                                                        <h6 class="check-title">
                                                            ...
                                                            {else}
                                                                {if ($DiscountCenterAddonIsActive)}
                                                                    ...
                                                                    {if isset($RSThemes['addonSettings']['product_domain_free_price']) && $RSThemes['addonSettings']['product_domain_free_price'] == 'true'}
                                                                        {if $pricing.cycles.biennially|strstr:$LANG.orderfreedomainonly && $freeDomainAssignedToProduct}{$freeDomainBiennially = true}{/if}
                                                                    {else}
                                                                ...
                                                                {else}
                                                                    {if isset($RSThemes['addonSettings']['product_domain_free_price']) && $RSThemes['addonSettings']['product_domain_free_price'] == 'true'}
                                                                        {if $pricing.biennially|strstr:$LANG.orderfreedomainonly && $freeDomainAssignedToProduct}{$freeDomainBiennially = true}{/if}
                                                                    {else}
                                                        ...
                                                        <h6 class="check-title">
                                                            ...
                                                            {else}
                                                                ...
                                                                {else}
                                                                    {if $pricing.biennially|strstr:$LANG.orderfreedomainonly}{$freeDomainBiennially = true}{/if}
                                                                {/if}
                                                                {$pricing.biennially|replace:$LANG.orderpaymenttermbiennially:""|replace:$WHMCSCurrency.suffix:" `$WHMCSCurrency.suffix`"|replace:" (`$LANG.orderfreedomainonly`)":""}{if $freeDomainBiennially} ({$LANG.orderfreedomainonly}){/if}
                                                            {/if} 
                                                        </h6>
                                                    {/if}
                                                        ...
                                                        <h6 class="check-title">
                                                            ...
                                                            {else}
                                                                {if ($DiscountCenterAddonIsActive)}
                                                                    ...
                                                                    {if isset($RSThemes['addonSettings']['product_domain_free_price']) && $RSThemes['addonSettings']['product_domain_free_price'] == 'true'}
                                                                        {if $pricing.cycles.triennially|strstr:$LANG.orderfreedomainonly && $freeDomainAssignedToProduct}{$freeDomainTriennially = true}{/if}
                                                                    {else}
                                                                ...
                                                                {else}
                                                                    {if isset($RSThemes['addonSettings']['product_domain_free_price']) && $RSThemes['addonSettings']['product_domain_free_price'] == 'true'}
                                                                        {if $pricing.triennially|strstr:$LANG.orderfreedomainonly && $freeDomainAssignedToProduct}{$freeDomainTriennially = true}{/if}
                                                                    {else}
                            ...
                            <div class="panel-body">
                                {if $hideServerFields}    
                                    <div class="row hidden">
                                        ...
                                        {if $RSThemes['addonSettings']['custom_hostname_prefix'] || $RSThemes['addonSettings']['custom_hostname_prefix'] == ""}
                                        ...
                                        {if $RSThemes['addonSettings']['custom_hostname_suffix'] || $RSThemes['addonSettings']['custom_hostname_suffix'] == ""}
                                            {assign var="hostname_suffix" value=$RSThemes['addonSettings']['custom_hostname_suffix']}
                                        {/if}
                                        {if isset($RSThemes['addonSettings']['custom_hostname_chars'])}
                                            {assign var="custom_hostname_chars" value=","|explode:$RSThemes['addonSettings']['custom_hostname_chars']}
                                        {/if}

                                        {$hostnameUppercaseChars = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"}
                                        {$hostnameLowercaseChars = "abcdefghijklmnopqrstuvwxyz"}
                                        {$hostnameNumberChars = "0123456789"}
                                        {$hostnameChars = ""}
                                        {if 
                                            !isset($RSThemes['addonSettings']['enable_custom_hostname']) || 
                                            $RSThemes['addonSettings']['enable_custom_hostname'] == "0" || 
                                            !isset($RSThemes['addonSettings']['custom_hostname_chars']) || 
                                            (
                                                is_array($custom_hostname_chars) && 
                                                (
                                                    in_array("all", $custom_hostname_chars) ||
                                                    $custom_hostname_chars|@count == 3
                                                )
                                            )
                                        }
                                            {assign var="hostnameChars" value="`$hostnameUppercaseChars``$hostnameLowercaseChars``$hostnameNumberChars`"}
                                        {elseif (is_array($custom_hostname_chars))}
                                            
                                            {if in_array("uppercase", $custom_hostname_chars)}
                                                {$hostnameChars = "`$hostnameChars``$hostnameUppercaseChars`"}
                                            {/if}
                                            {if in_array("lowersace", $custom_hostname_chars)}
                                                {$hostnameChars = "`$hostnameChars``$hostnameLowercaseChars`"}
                                            {/if}
                                            {if in_array("numbers", $custom_hostname_chars)}
                                                {$hostnameChars = "`$hostnameChars``$hostnameNumberChars`"}
                                            {/if}
                                        {else}
                                            {assign var="hostnameChars" value="`$hostnameUppercaseChars``$hostnameLowercaseChars``$hostnameNumberChars`"}   
                                        {/if}
                                        ...
                                        {literal}
                                            <script>
                                                function makeid(length) {
                                                    var result = '';
                                                    var characters = '{/literal}{$hostnameChars}{literal}';
                                ...
                                {else}
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="inputHostname">{$LANG.serverhostname}</label>
                                                <input type="text" name="hostname" class="form-control" id="inputHostname" value="{$server.hostname}" placeholder={$rslang->trans('order.servername_example')}>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                            ...
                            <div class="section-body">
                                <div class="panel-check-group row row-eq-height" data-inputs-container>
                                    {foreach $addons as $addon}
                                        <div class="col-sm-{if $RSThemes['pages']['configureproduct']['config']['addonsColumns'] === "1"}12{else}{if count($addons) > 1}6{else}12{/if}{/if}">
            ...
            <div class="main-sidebar main-sidebar-lg{if $sidebarOnRight || $RSThemes['layouts']['name'] == 'left-nav-wide'} main-sidebar-right{/if}">
                <div class="sidebar-sticky sidebar-sticky-summary" id="orderSummary" {if $RSThemes.addonSettings.show_affixed_navigation == 'enabled'}data-sidebar-sticky{/if}>
                    <div class="panel panel-summary panel-summary-{$summaryStyle} order-summary m-b-0x {if isset($RSThemes['pages'][$templatefile]) && $RSThemes['pages'][$templatefile]['config']['removeProductGroupName'] === "1"}hidden-pg{/if}">
