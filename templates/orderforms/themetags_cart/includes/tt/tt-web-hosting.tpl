<div class="tt-product-featured-wrap mt-5">
    <div class="row justify-content-lg-between align-items-center">
        ...
        <div class="col-lg-5">
            <img src="{$WEB_ROOT}/templates/{$template}/img/tt-product-feature-1.svg" class="img-fluid" alt="support image">
        </div>
    </div>

    <div class="row justify-content-lg-between align-items-center">
        <div class="col-lg-5">
            <img src="{$WEB_ROOT}/templates/{$template}/img/tt-product-feature-2.svg" class="img-fluid" alt="support image">
        </div>
        <div class="col-lg-6">
            <div class="tt-cta-content ptb-60">
    ...
    <div class="row justify-content-lg-between align-items-center">
        ...
        <div class="col-lg-5">
            <img src="{$WEB_ROOT}/templates/{$template}/img/tt-product-feature-3.svg" class="img-fluid" alt="support image">
        </div>
    </div>
</div>
