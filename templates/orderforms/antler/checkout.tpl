        ...
        <form method="post" action="{$smarty.server.PHP_SELF}?a=checkout" name="orderfrm" id="frmCheckout">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="already-registered clearfix new-set bg-seccolorstyle bg-pratalight border-0 noshadow">
                        <div class="login-claaa-box {if $loggedin} w-hidden{/if}">
                            ...
                            <div id="containerExistingUserSignin"{if $loggedin || $custtype neq "existing"} class="w-hidden{/if}">
                                <div class="sub-heading">
                                    <span class="mergecolor">{$LANG.orderForm.existingCustomerLogin}</span>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group prepend-icon">
                                            ...
                                            <input type="text" name="loginemail" id="inputLoginEmail" class="field form-control m-0" placeholder="{$LANG.orderForm.emailAddress}" value="{$loginemail}">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group prepend-icon">
                                            ...
                                            <input type="password" name="loginpassword" id="inputLoginPassword" class="field form-control mergecolor m-0" placeholder="{$LANG.clientareapassword}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="text-left">
                                    <button type="button" id="btnExistingLogin" class="btn btn-primary btn-md">
                                        ...
                                        <span id="existingLoginPleaseWait" class="w-hidden mergecolor">{lang key='pleasewait'}</span>
                                    </button>
                                </div>
                        ...
                        <div class="regi-claaa-box {if $loggedin || !$loggedin && $custtype eq "existing"}rah-login{/if}">
                            ...
                            >
                                ...
                                {if $customfields}
                                <div class="sub-heading">
                                    <span class="mergecolor">{$LANG.orderadditionalrequiredinfo}<br><i><small>{lang key='orderForm.requiredField'}</small></i></span>
                                </div>
                            ...
                            <div class="row margin-bottom">
                                <div class="col-sm-12 custom-arrow mt-20">
                                    <select name="contact" id="inputDomainContact" class="field bg-colorstyle border-0 noshadow bg-white">
                    ...
                    <div id="applyCreditContainer" class="br-12 noshadow p-5 bg-seccolorstyle bg-pratalight border-0 apply-credit-container{if !$canUseCreditOnCheckout} w-hidden{/if}" data-apply-credit="{$applyCredit}">
                        <p>{lang key='cart.availableCreditBalance' amount=$creditBalance}</p>

                        <label class="radio pl-0">
                    ...
                    <div id="paymentGatewaysContainer" class="form-group br-12 noshadow p-5 bg-seccolorstyle bg-pratalight border-0">
                        <div class="d-grid">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group p-0">
                                <textarea name="notes" class="field bg-seccolorstyle bg-pratalight border-0 noshadow" rows="4" placeholder="{$LANG.ordernotesdescription}" style="border-radius:12px !important">{$orderNotes}</textarea>
                            </div>
                        </div>
                    </div>
                    {/if}
