                    ...
                    <div class="col-md-8">
                        ...
                        <form method="post" action="{$WEB_ROOT}/cart.php?a=view">
                            ...
                            <div class="view-cart-items pb-3">
                                ...
                                <div class="item bg-seccolorstyle bg-pratalight border-0 noshadow">
                                    <div class="item-header">
                                        <a class="badge feat bg-danger mr-30" data-toggle="tooltip" data-placement="left" title="{$LANG.orderForm.remove}" type="button" class="btn-remove-from-cart" onclick="removeItem('r','{$num}','domain')"><i class="ico-trash-2 f-16"></i></a>
                                        <div class="row">
                                            <div class="col-md-12 mb-15">
                                                <span class="item-title mergecolor">
                                                    {$LANG.domainrenewal}
