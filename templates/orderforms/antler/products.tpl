            ...
            <section class="services sec-normal">
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <h4 class="mergecolor">{$LANG.orderForm.includedWithPlans}</h4>
                    </div>
                </div>
                <div class="col-md-12 t">
                    <div class="service-wrap">
                        ...
                        {foreach $productGroup.features as $features}
                            <div class="col-sm-3 col-md-3 col-lg-3 mergecolor">
                                <div class="service-section bg-seccolorstyle noshadow">
                                    <p style="display:flex;align-items:center;margin:0px; class="subtitle text-center"><i class="fas fa-check-circle c-pink f-24 mr-10"></i> {$features.feature}</p>
                                </div>
                            </div>  
                        {/foreach}
                        </div>
