...
<div id="order-phox">
    ...
    <div class="header-lined">
        ...
        <small>{lang key='orderForm.enterPersonalDetails'}</small>
    </div>
    ...
    <div class="row">
        <div class="cart-body cart-body--full-width">
            ...
            <div class="already-registered clearfix">
                <div class="pull-right float-right">
                    ...
                    <button type="button" class="btn btn-info{if $loggedin || $custtype neq "existing"} w-hidden{/if}"
                        id="btnNewUserSignup">
            ...
            {if $errormessage}
                <div class="alert alert-danger checkout-error-feedback alert-have-list" role="alert">
            ...
            <form method="post" action="{$smarty.server.PHP_SELF}?a=checkout" name="orderfrm" id="frmCheckout">
                ...
                {if $custtype neq "new" && $loggedin}
                    <div class="mb-2">
                        <h4 class="wdes-main-title">{lang key='switchAccount.title'}</h4>
                    </div>
                    ...
                    <div id="containerExistingUserSignin" {if $loggedin || $custtype neq "existing"} class="w-hidden{/if}">
                        <div class="mb-2">
                            <h4 class="wdes-main-title">{$LANG.orderForm.existingCustomerLogin}</h4>
                        </div>
                        ...
                        <div class="wdes-phox-block">
                            ...
                            {include file="orderforms/phox/linkedaccounts.tpl" linkContext="checkout-existing"}
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div{if $loggedin} class="w-hidden" {/if}>
                            {include file="orderforms/phox/linkedaccounts.tpl" linkContext="checkout-new"}
                    </div>

                    <div class="mb-2">
                        <h4 class="wdes-main-title">{$LANG.orderForm.personalInformation}</h4>
                    </div>

                    <div class="wdes-phox-block mb-4">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group prepend-icon">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group prepend-icon">
                                    ...
                                    <input type="tel" name="phonenumber" id="inputPhone" class="field form-control"
                                        placeholder="{$LANG.orderForm.phoneNumber}" value="{$clientsdetails.phonenumber}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-2">
                        <h4 class="wdes-main-title">{$LANG.orderForm.billingAddress}</h4>
                    </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group prepend-icon">
                                    ...
                                    <input type="text" name="address2" id="inputAddress2" class="field form-control"
                                        placeholder="{$LANG.orderForm.streetAddress2}" value="{$clientsdetails.address2}">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group prepend-icon">
                    ...
                    {if $customfields}
                        <div class="mb-2">
                            <h4 class="wdes-main-title">
                                {$LANG.orderadditionalrequiredinfo}<br><i><small>{lang key='orderForm.requiredField'}</small></i>
                            </h4>
                        </div>
            ...
            {if $domainsinorder}
                ...
                <div class="mb-2">
                    <h4 class="wdes-main-title">{$LANG.domainregistrantinfo}</h4>
                </div>
                        ...
                        <div class="row" id="domainRegistrantInputFields">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group prepend-icon">
                                    ...
                                    <input type="email" name="domaincontactemail" id="inputDCEmail" class="field form-control"
                                        placeholder="{$LANG.orderForm.emailAddress}" value="{$domaincontact.email}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group prepend-icon">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group prepend-icon">
                                    ...
                                    <input type="text" name="domaincontactcity" id="inputDCCity" class="field form-control"
                                        placeholder="{$LANG.orderForm.city}" value="{$domaincontact.city}">
                                </div>
                            </div>
                            <div class="col-sm-5">
                                <div class="form-group prepend-icon">
                                    ...
                                    <input type="text" name="domaincontactstate" id="inputDCState" class="field form-control"
                                        placeholder="{$LANG.orderForm.state}" value="{$domaincontact.state}">
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group prepend-icon">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group prepend-icon">
                                    ...
                                    <input type="text" name="domaincontacttax_id" id="inputDCTaxId" class="field form-control"
                                        placeholder="{$taxLabel} ({$LANG.orderForm.optional})" value="{$domaincontact.tax_id}">
                                </div>
                            </div>
                        </div>
                </div>
        ...
        {if !$loggedin}
            ...
            <div id="containerNewUserSecurity"
                {if (!$loggedin && $custtype eq "existing") || ($remote_auth_prelinked && !$securityquestions)} class="w-hidden"
                {/if}>

                <div class="mb-2">
                    <h4 class="wdes-main-title">{$LANG.orderForm.accountSecurity}</h4>
                </div>
        ...
        <div class="mb-2">
            <h4 class="wdes-main-title">{$LANG.orderForm.paymentDetails}</h4>
        </div>
            ...
            <div id="applyCreditContainer" class="apply-credit-container{if !$canUseCreditOnCheckout} w-hidden{/if}"
                ...
                <label class="radio">
                    <input id="useCreditOnCheckout" type="radio" name="applycredit" value="1" {if $applyCredit}
                        checked{/if}>
                    <span id="spanFullCredit" {if !($creditBalance->toNumeric() >= $total->toNumeric())} class="w-hidden"
                        {/if}>
                ...
                <div class="cc-input-container{if $selectedgatewaytype neq "CC"} w-hidden{/if}" id="creditCardInputFields">
                    {if $client}
                        <div id="existingCardsContainer" class="existing-cc-grid">
                            {include file="orderforms/phox/includes/existing-paymethods.tpl"}
                        </div>
                    {/if}
                            ...
                            {if $allowClientsToRemoveCards}
                                <div id="inputNoStoreContainer" class="col-md-6" style="line-height: 32px;">
                                    ...
                                    <input type="checkbox" class="toggle-switch-success no-icheck" data-size="mini"
                                        checked="checked" name="nostore" id="inputNoStore" value="0" data-on-text="{lang key='yes'}"
        ...
        {if $shownotesfield}
            ...
            <div class="mb-2">
                <h4 class="wdes-main-title">{$LANG.orderForm.additionalNotes}</h4>
            </div>
        ...
        {if $showMarketingEmailOptIn}
            <div class="mb-2">
                <h4 class="wdes-main-title">{lang key='emailMarketing.joinOurMailingList'}</h4>
            </div>
    ...
    {include file="orderforms/phox/recommendations-modal.tpl"}