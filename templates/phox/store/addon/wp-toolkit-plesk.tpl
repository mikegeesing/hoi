{if file_exists("templates/$template/packages/overwrites/store/addon/wp-toolkit-plesk.tpl")}
    {include file="{$template}/packages/overwrites/store/addon/wp-toolkit-plesk.tpl"}
{else}
