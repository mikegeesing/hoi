{if file_exists("templates/$template/packages/overwrites/store/addon/wp-toolkit-cpanel.tpl")}
    {include file="{$template}/packages/overwrites/store/addon/wp-toolkit-cpanel.tpl"}
{else}
            ...
            <div class="container">
                ...
                {if $hasPleskWptk}
                    <p>
                        ...
                        <a
                            href="{fqdnRoutePath('store-addon', 'plesk-wordpress-toolkit-with-smart-updates')}">{lang key='clickHere'}</a>
                    </p>
                {/if}
            </div>
        </div>
                        ...
                        <div class="row screenshots-row">
                            <div class="col-md-6">
                                <a href="{$WEB_ROOT}/assets/img/store/wp-toolkit/screen-01-full.png"
                                    class="screenshot-thumb" data-lightbox="wptoolkit">
                                ...
                                <div class="inner-content">
                                    ...
                                    {if $service['addon']}
                                        <div class="description">
                                            {lang key='store.addon.wptk.addAddonFor' addon={$service['addon']->name}}</div>
                                        <div class="price">
