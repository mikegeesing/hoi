{if file_exists("templates/$template/packages/overwrites/store/sitelockvpn/index.tpl")}
    {include file="{$template}/packages/overwrites/store/sitelockvpn/index.tpl"}
{else}
                    ...
                    <div class="row">
                        {foreach $plans as $plan}
                            {foreach $pricings[$plan->id] as $pricing}
                                <div
                                    class="{if $pricing@total == 1}col-sm-4 col-sm-offset-4{elseif $pricing@total == 2}col-sm-6{elseif $pricing@total == 2}col-sm-6{elseif $pricing@total == 3}col-md-4 col-sm-4{elseif $pricing@total == 4}col-lg-3 col-sm-6{elseif $pricing@total == 5}col-md-4 col-sm-6{else}col-lg-3 col-sm-4{/if}">
                                    <div class="pricing-box">
                                        ...
                                        <div class="signup">
                                            <form method="post" action="{routePath('cart-order')}">
                                                ...
                                                {/if}
                                                <button type="submit"
                                                    class="btn btn-block btn-signup{if $pricing@iteration == ($pricing@total - 1)} highlight1{elseif $pricing@iteration == $pricing@total} highlight2{/if}">
                                                    {lang key="signup"}
                                                </button>
                                            </form>
                                        </div>
