{if file_exists("templates/$template/packages/overwrites/store/ssl/shared/features.tpl")}
    {include file="{$template}/packages/overwrites/store/ssl/shared/features.tpl"}
{else}
