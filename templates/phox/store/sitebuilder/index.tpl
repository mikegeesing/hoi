{if file_exists("templates/$template/packages/overwrites/store/sitebuilder/index.tpl")}
    {include file="{$template}/packages/overwrites/store/sitebuilder/index.tpl"}
{else}
        ...
        <div class="features" id="features">
            <div class="container">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#essentials" aria-controls="essentials" role="tab"
                            data-toggle="tab">{lang key="store.siteBuilder.featuresEssentials"}</a></li>
                    <li role="presentation"><a href="#social" aria-controls="social" role="tab"
                            data-toggle="tab">{lang key="store.siteBuilder.featuresSocial"}</a></li>
                    <li role="presentation"><a href="#store" aria-controls="store" role="tab"
                            data-toggle="tab">{lang key="store.siteBuilder.featuresStore"}</a></li>
                </ul>
        ...
        <div class="container">
            <div class="templates">
                ...
                <ul class="nav nav-tabs justify-content-center" role="tablist">
                    <li class="nav-item">
                        <a href="#" class="nav-link templates-filter-btn"
                            data-type="single">{lang key="store.siteBuilder.templates.singlePage"}</a>
                    </li>
                    <li class="nav-item">
                        <a href="#" class="nav-link templates-filter-btn"
                            data-type="multi">{lang key="store.siteBuilder.templates.multiPage"}</a>
                    </li>
                    <li class="nav-item">
                        <a href="#" class="nav-link templates-filter-btn"
                            data-type="ecom">{lang key="store.siteBuilder.templates.eCommerce"}</a>
                    </li>
                </ul>
                <div class="previews">
                    <div class="row">
                                ...
                                <div class="col-md-6 col-lg-4 type-{$template['type']}{if $i > 11} hidden{/if}">
                                    <a href="{$template['preview']}" target="_blank">
                                        <div class="thumb-wrapper">
                                            ...
                                            <span
                                                class="type-label">{lang key="store.siteBuilder.templates.typeLabels.{$template['type']}"}</span>
                                        </div>
    ...
    <script>
        ...
        jQuery(document).ready(function() {
            jQuery(baseRef + ' .templates-filter-btn').click(function(e) {
                ...
                showAllTemplates();
                jQuery(baseRef + ' .previews .type-single,' + baseRef + ' .previews .type-multi,' +
                    baseRef + ' .previews .type-ecom').hide();
