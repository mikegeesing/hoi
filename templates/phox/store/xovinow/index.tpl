{if file_exists("templates/$template/packages/overwrites/store/xovinow/index.tpl")}
    {include file="{$template}/packages/overwrites/store/xovinow/index.tpl"}
{else}
    ...
    <div class="landing-page xovinow">
        <div class="header text-center text-lg-left mb-xl-5">
            <div class="container">
                ...
                <img src="{$WEB_ROOT}/assets/img/marketconnect/xovinow/header-img.png"
                    class="header-img d-none d-lg-inline">
        ...
        <div class="content-block feature-carousel mt-lg-3">
            <div class="carousel-container">
                ...
                <div id="xovinow-screenshots" class="carousel slide" data-ride="carousel" data-interval="10000">
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="item">
                            <img
                                src="{$WEB_ROOT}/assets/img/marketconnect/xovinow/screenshots/keyword_research_keywords.png">
                        </div>
                        <div class="item">
            ...
            <div class="container">
                <h3 class="mt-sm-3 mt-md-5 text-center">
                    <p>{lang key="store.xoviNow.measureResultsTitle"}
                </h3>
                <br>
                <div class="row">
                    <div class="col-lg-6">
        ...
        <div class="content-block feature-tabs bg-white">
            <div class="container">
                ...
                <ul class="nav nav-tabs mt-sm-4 mt-md-4 mt-lg-5" role="tablist">
                    <li role="presentation" class="active"><a href="#keywords" aria-controls="keywords" role="tab"
                            data-toggle="tab">{lang key="store.xoviNow.features.keywords.title"}</a></li>
                    <li role="presentation"><a href="#advisor" aria-controls="advisor" role="tab"
                            data-toggle="tab">{lang key="store.xoviNow.features.advisor.title"}</a></li>
                    <li role="presentation"><a href="#ranktracker" aria-controls="ranktracker" role="tab"
                            data-toggle="tab">{lang key="store.xoviNow.features.rankTracker.title"}</a></li>
                    <li role="presentation"><a href="#siteaudit" aria-controls="siteaudit" role="tab"
                            data-toggle="tab">{lang key="store.xoviNow.features.siteAudit.title"}</a></li>
                    <li role="presentation"><a href="#textoptimizer" aria-controls="textoptimizer" role="tab"
                            data-toggle="tab">{lang key="store.xoviNow.features.textOptimizer.title"}</a></li>
                    <li role="presentation"><a href="#benchmarking" aria-controls="benchmarking" role="tab"
                            data-toggle="tab">{lang key="store.xoviNow.features.benchmarking.title"}</a></li>
                </ul>
                                    ...
                                    <div class="plan{if $plan->is_featured} featured{/if}">
                                        ...
                                        {foreach $plan->features as $feature => $value}
                                            <div class="plan-feature{if is_bool($value)} || $value < 2} row-highlight{/if}">
                                                ...
                                                {/if}
                                                <span
                                                    class="d-md-none">{lang key="store.xoviNow.featurematrix."|cat:$value@iteration}</span>
                                            </div>
                                        {/foreach}
                                        <div class="buy-btn">
                                            <form action="{routePath('cart-order')}" method="post">
                                                ...
                                                <button type="submit"
                                                    class="btn {if $plan->is_featured}btn-xovinow{else}btn-default{/if}">
                        ...
                        <div class="panel-group" id="xovinowFAQ" role="tablist">
                            <div class="panel panel-default">
                                <div class="panel-heading" id="heading1">
                                    <h2 class="panel-title mb-0">
                                        <a class="btn btn-link btn-block text-left" type="button" data-toggle="collapse"
                                            data-parent="#xovinowFAQ" href="#collapse1" aria-expanded="true"
                                ...
                                <div id="collapse1" class="panel-collapse collapse in" role="tabpanel"
                                    aria-labelledby="heading1" data-parent="#xovinowFAQ">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading" id="heading2">
                                    <h2 class="panel-title mb-0">
                                        <a class="btn btn-link btn-block text-left collapsed" type="button"
                                            data-toggle="collapse" data-parent="#xovinowFAQ" href="#collapse2"
                                ...
                                <div id="collapse2" class="panel-collapse collapse" role="tabpanel"
                                    aria-labelledby="heading2" data-parent="#xovinowFAQ">
                                    <div class="panel-body">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading" id="heading3">
                                    <h2 class="panel-title mb-0">
                                        <a class="btn btn-link btn-block text-left collapsed" type="button"
                                            data-toggle="collapse" data-parent="#xovinowFAQ" href="#collapse3"
                                ...
                                <div id="collapse3" class="panel-collapse collapse" role="tabpanel"
                                    aria-labelledby="heading3" data-parent="#xovinowFAQ">
                                    <div class="panel-body">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading" id="heading4">
                                    <h2 class="panel-title mb-0">
                                        <a class="btn btn-link btn-block text-left" type="button" data-toggle="collapse"
                                            data-parent="#xovinowFAQ" href="#collapse4" aria-expanded="true"
                                ...
                                <div id="collapse4" class="panel-collapse collapse" role="tabpanel"
                                    aria-labelledby="heading4" data-parent="#xovinowFAQ">
                                    <div class="panel-body">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading" id="heading5">
                                    <h2 class="panel-title mb-0">
                                        <a class="btn btn-link btn-block text-left" type="button" data-toggle="collapse"
                                            data-parent="#xovinowFAQ" href="#collapse5" aria-expanded="true"
                                ...
                                <div id="collapse5" class="panel-collapse collapse" role="tabpanel"
                                    aria-labelledby="heading5" data-parent="#xovinowFAQ">
                                    <div class="panel-body">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading" id="heading6">
                                    <h2 class="panel-title mb-0">
                                        <a class="btn btn-link btn-block text-left" type="button" data-toggle="collapse"
                                            data-parent="#xovinowFAQ" href="#collapse6" aria-expanded="true"
                                ...
                                <div id="collapse6" class="panel-collapse collapse" role="tabpanel"
                                    aria-labelledby="heading6" data-parent="#xovinowFAQ">
                                    <div class="panel-body">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading" id="heading7">
                                    <h2 class="panel-title mb-0">
                                        <a class="btn btn-link btn-block text-left" type="button" data-toggle="collapse"
                                            data-parent="#xovinowFAQ" href="#collapse7" aria-expanded="true"
                                ...
                                <div id="collapse7" class="panel-collapse collapse" role="tabpanel"
                                    aria-labelledby="heading7" data-parent="#xovinowFAQ">
                                    <div class="panel-body">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading" id="heading8">
                                    <h2 class="panel-title mb-0">
                                        <a class="btn btn-link btn-block text-left" type="button" data-toggle="collapse"
                                            data-parent="#xovinowFAQ" href="#collapse8" aria-expanded="true"
                                ...
                                <div id="collapse8" class="panel-collapse collapse" role="tabpanel"
                                    aria-labelledby="heading8" data-parent="#xovinowFAQ">
                                    <div class="panel-body">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading" id="heading9">
                                    <h2 class="panel-title mb-0">
                                        <a class="btn btn-link btn-block text-left" type="button" data-toggle="collapse"
                                            data-parent="#xovinowFAQ" href="#collapse9" aria-expanded="true"
                                ...
                                <div id="collapse9" class="panel-collapse collapse" role="tabpanel"
                                    aria-labelledby="heading9" data-parent="#xovinowFAQ">
                                    <div class="panel-body">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading" id="heading10">
                                    <h2 class="panel-title mb-0">
                                        <a class="btn btn-link btn-block text-left" type="button" data-toggle="collapse"
                                            data-parent="#xovinowFAQ" href="#collapse10" aria-expanded="true"
                                ...
                                <div id="collapse10" class="panel-collapse collapse" role="tabpanel"
                                    aria-labelledby="heading10" data-parent="#xovinowFAQ">
                                    <div class="panel-body">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading" id="heading11">
                                    <h2 class="panel-title mb-0">
                                        <a class="btn btn-link btn-block text-left" type="button" data-toggle="collapse"
                                            data-parent="#xovinowFAQ" href="#collapse11" aria-expanded="true"
                                ...
                                <div id="collapse11" class="panel-collapse collapse" role="tabpanel"
                                    aria-labelledby="heading11" data-parent="#xovinowFAQ">
                                    <div class="panel-body">
                                        {lang key="store.xoviNow.faq11ans" image1='<img src="{$WEB_ROOT}/assets/img/marketconnect/xovinow/faq-advisor.png">'
                                        image2='<img
                                        src="{$WEB_ROOT}/assets/img/marketconnect/xovinow/faq-googlectrchart.png">'
                                        image3='<img
                                        src="{$WEB_ROOT}/assets/img/marketconnect/xovinow/faq-googlectrpages.png">'
                                        googleWebmasterGuidelinesUrl="https://developers.google.com/search/docs/advanced/guidelines/webmaster-guidelines"
                                        waybackMachineUrl="https://archive.org/web/"}
                                    </div>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                <div class="panel-heading" id="heading12">
                                    <h2 class="panel-title mb-0">
                                        <a class="btn btn-link btn-block text-left" type="button" data-toggle="collapse"
                                            data-parent="#xovinowFAQ" href="#collapse12" aria-expanded="true"
                                ...
                                <div id="collapse12" class="panel-collapse collapse" role="tabpanel"
                                    aria-labelledby="heading12" data-parent="#xovinowFAQ">
                                    <div class="panel-body">
