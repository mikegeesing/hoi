{if file_exists("templates/$template/packages/overwrites/store/ox/index.tpl")}
    {include file="{$template}/packages/overwrites/store/ox/index.tpl"}
{else}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p>{lang key="store.ox.faq4.answer"}<br><br>
                                    <small>{lang key="store.ox.faq4.devices"}</small>
                                </p>
                            </div>
                            <div class="col-md-6">
