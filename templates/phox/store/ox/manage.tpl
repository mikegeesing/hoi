{if file_exists("templates/$template/packages/overwrites/store/ox/manage.tpl")}
    {include file="{$template}/packages/overwrites/store/ox/manage.tpl"}
{else}
    ...
    <table class="ox-table-accounts table">
        ...
        <tbody class="cloneAccountsBody hidden" data-account-id="" data-account="" data-first-name="" data-last-name=""
            data-display-name="">
            <tr>
                <td>
                ...
                <td class="text-right">
                    <div class="menu-sm">
                        <div class="btn-group" role="group">
                            <button type="button" class="btn btn-default btn-sm dropdown-toggle dropdown-hamburger"
        ...
        <tr class="cloneAliasRow hidden" data-alias="">
    ...
    <div class="tab-content product-details-tab-container" style="font-size:0.9em;">
        ...
        <div class="tab-pane fade hidden" id="migration">
            ...
            <div>
                <a class="migration-url btn btn-info btn-block btn-lg" href="#"
                    target="_blank">{lang key="ox.settings.migrationLaunch"}</a>
            </div>
        </div>
    </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content panel-primary">
                    <div class="modal-header panel-heading">
                        <button type="button" class="close" data-dismiss="modal" aria-label="{lang key='close'}"><span
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="inputFirstName" type="text" autocomplete="off" class="form-control required"
                                        name="first">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="inputLastName" type="text" autocomplete="off" class="form-control required"
                                        name="last">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="inputDisplayName" type="text" autocomplete="off"
                                        class="form-control required" name="display">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input id="inputEmailAddress" type="text" autocomplete="off"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="password" class="form-control required" name="password"
                                            id="inputPassword" data-error-threshold="{$pwStrengthErrorThreshold}"
                                            data-warning-threshold="{$pwStrengthWarningThreshold}"
                                            placeholder="{lang key="loginpassword"}" autocomplete="off" />
                                        <span class="input-group-btn">
                                            <button type="button" class="btn btn-default generate-password"
                                                data-targetfields="inputPassword,inputConfirmPassword">
                                    ...
                                    <div class="password-strength-meter">
                                        ...
                                        <p class="text-center small text-muted" id="passwordStrengthTextLabel">
                                            {lang key="pwstrength"}: {lang key="pwstrengthenter"}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="inputConfirmPassword" type="password" autocomplete="off"
                                        class="form-control required match" data-match-field="inputPassword"
                                        name="password2">
                ...
                <div class="modal-content panel-primary">
                    ...
                    <div class="modal-body panel-body" id="modalSetPasswordBody">
                        ...
                        <div class="form-group">
                            ...
                            <input id="inputManageDisplayName" type="text" autocomplete="off" class="form-control required"
                                name="display">
                            <span class="field-error-msg">{lang key='ox.required.displayName'}</span>
                        </div>
                        <div class="form-group">
                            <label for="inputManageFirstName">{lang key='orderForm.firstName'}</label>
                            <input id="inputManageFirstName" type="text" autocomplete="off" class="form-control required"
                                name="first">
                            <span class="field-error-msg">{lang key='ox.required.firstName'}</span>
                        </div>
                        <div class="form-group">
                            <label for="inputManageLastName">{lang key='orderForm.lastName'}</label>
                            <input id="inputManageLastName" type="text" autocomplete="off" class="form-control required"
                                name="last">
                            <span class="field-error-msg">{lang key='ox.required.lastName'}</span>
                        </div>
                    </div>
                ...
                <div class="modal-content panel-primary">
                    ...
                    <div class="modal-body panel-body" id="modalSetPasswordBody">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="password" class="form-control required" name="password"
                                    id="inputChangePassword" data-error-threshold="{$pwStrengthErrorThreshold}"
                                    data-warning-threshold="{$pwStrengthWarningThreshold}"
                                    placeholder="{lang key="loginpassword"}" autocomplete="off" />
                                <span class="input-group-btn">
                                    <button type="button" class="btn btn-default generate-password"
                                        data-targetfields="inputChangePassword,inputChangePasswordConfirm">
                                        {lang key="generatePassword.btnShort"}
                                    </button>
                                </span>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="inputChangePasswordConfirm" type="password" autocomplete="off"
                                class="form-control required match" data-match-field="inputChangePassword" name="password2">
                            <span class="field-error-msg">{lang key='ox.required.passwordMatch'}</span>
                        </div>
                    </div>
                    <div class="modal-footer panel-footer">
            ...
            <div class="modal-dialog">
                <div class="modal-content panel-primary">
                    ...
                    <div class="modal-body panel-body" id="modalDeleteAccountBody">
                        ...
                        <span class="delete-aliases-question"
                            aria-hidden="true">{lang key='ox.deleteAccountWithAliasesQuestion'}</span>
                    </div>
                    <div class="modal-footer panel-footer">
                        <div class="pull-left loader hidden">
                            <i class="fas fa-sync-alt fa-spin"></i>
            ...
            jQuery(document)
                ...
                .on('click', '.ox-delete', function(e) {
                    var accountId = jQuery(this).closest('tbody.account-entry').data('account-id'),
                        ...
                        aliasCount = jQuery(this).closest('tbody.account-entry').find('span.alias-count')
                    .text(),
