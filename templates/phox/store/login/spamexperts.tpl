{if file_exists("templates/$template/packages/overwrites/store/login/spamexperts.tpl")}
    {include file="{$template}/packages/overwrites/store/login/spamexperts.tpl"}
{else}
                        ...
                        <p>
                            ...
                            {else}
                                <input type="hidden" name="service-id"
                                    value="{if $accounts[0].type == 'addon'}a{/if}{$accounts[0].id}">
                            {/if}
                        </p>
