{if file_exists("templates/$template/packages/overwrites/store/nordvpn/index.tpl")}
    {include file="{$template}/packages/overwrites/store/nordvpn/index.tpl"}
{else}
                ...
                <div class="hero-bg">
                    <div class="row h-100">
                        <div class="col-xs-12 col-lg-6 my-auto">
                            ...
                            <h1>{lang key="store.nordvpn.hero.title" tagOpen="<span class=\"blue\">" tagClose="</span>" tagBreak="<br class=\"br-md-space br-lg-reg br-xl-space\">"}
                            </h1>
                            <h2>{lang key="store.nordvpn.hero.tagline" tagBreak="<br class=\"br-xs-space br-sm-space br-md-reg br-lg-space\">"}
                            </h2>
                        </div>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-xs-12">
                        <div class="row no-gutters">
                            ...
                            <div class="col-xs-2">
                                <span>
                                    <button class="btn btn-default btn-get-nord btn-get-deal"
                                        onclick="smoothScroll('#nordPricing')">{lang key="store.nordvpn.shared.get"}</button>
                                </span>
                            </div>
                            <div class="col-xs-2"></div>
                            <div class="col-xs-2"></div>
                    ...
                    <div class="col-xs-12 col-lg-6">
                        ...
                        <div class="world-desc">
                            ...
                            <p class="world-tagline">
                                {lang key="store.nordvpn.features.world.tagline" tagBreak="<br class=\"br-xs-space br-lg-space br-xl-reg\">"}
                            </p>
                            ...
                            <button class="btn btn-default btn-get-nord btn-get-deal"
                                onclick="smoothScroll('#nordPricing')">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xs-10 col-xs-offset-1">
                        <p>{lang key="store.nordvpn.features.use.tagline1" tagOpen="<strong>" tagClose="</strong>" tagBreak="<br class=\"br-sm-space br-lg-reg\">"}
                        </p>
                    </div>
                </div>
                ...
                <div class="row">
                    {foreach $plans as $plan}
                        {foreach $pricings[$plan->id] as $pricing}
                            <div
                                class="{if $pricing@total == 1}col-sm-4 col-sm-offset-4{elseif $pricing@total == 2}col-sm-6{elseif $pricing@total == 2}col-sm-6{elseif $pricing@total == 3}col-md-4 col-sm-4{elseif $pricing@total == 4}col-xl-3 col-sm-6{elseif $pricing@total == 5}col-md-4 col-sm-6{else}col-lg-3 col-sm-4{/if}">
                        ...
                        <div class="panel-group" id="nordvpnFaq">
                            <div class="panel">
                                ...
                                <div id="collapse1" class="panel-collapse collapse in" role="tabpanel"
                                    aria-labelledby="heading1" data-parent="#nordvpnFaq">
                            ...
                            <div class="panel">
                                ...
                                <div id="collapse2" class="panel-collapse collapse" role="tabpanel"
                                    aria-labelledby="heading2" data-parent="#nordvpnFaq">
                                    <div class="panel-body">
                            ...
                            <div class="panel">
                                ...
                                <div id="collapse3" class="panel-collapse collapse" role="tabpanel"
                                    aria-labelledby="heading3" data-parent="#nordvpnFaq">
                                    <div class="panel-body">
                            ...
                            <div class="panel">
                                ...
                                <div id="collapse4" class="panel-collapse collapse" role="tabpanel"
                                    aria-labelledby="heading4" data-parent="#nordvpnFaq">
                                    <div class="panel-body">
                            ...
                            <div class="panel">
                                ...
                                <div id="collapse5" class="panel-collapse collapse" role="tabpanel"
                                    aria-labelledby="heading5" data-parent="#nordvpnFaq">
                                    <div class="panel-body">
        ...
        jQuery(document).ready(function() {
            jQuery('.panel-group .panel-heading .btn').on('click', function() {
                ...
                if (icon.hasClass('fa-plus')) {
                    jQuery('.panel-group .panel-heading .btn i.fa-minus').removeClass('fa-minus').addClass(
                        'fa-plus');
