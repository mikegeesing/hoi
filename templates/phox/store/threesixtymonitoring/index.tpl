{if file_exists("templates/$template/packages/overwrites/store/threesixtymonitoring/upgrade.tpl")}
    {include file="{$template}/packages/overwrites/store/threesixtymonitoring/upgrade.tpl"}
{else}
