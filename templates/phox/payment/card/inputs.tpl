{if file_exists("templates/$template/packages/overwrites/payment/card/inputs.tpl")}
    {include file="{$template}/packages/overwrites/payment/card/inputs.tpl"}
{else}
    <div class="form-group cc-details{if !$addingNewCard} hidden{/if}">
        ...
        <div class="col-sm-7">
            <input type="tel" name="ccnumber" id="inputCardNumber" size="30" value="{if $ccnumber}{$ccnumber}{/if}"
    ...
    {if $showccissuestart}
        <div class="form-group cc-details{if !$addingNewCard} hidden{/if}">
            ...
            <div class="col-sm-8">
                <input type="tel" name="ccstartdate" id="inputCardStart" value="{$ccstartdate}"
                    class="form-control field input-inline input-inline-100"
    ...
    <div class="form-group cc-details{if !$addingNewCard} hidden{/if}">
        ...
        <div class="col-sm-8">
            <input type="tel" name="ccexpirydate" id="inputCardExpiry" value="{$ccexpirydate}"
                class="form-control field input-inline input-inline-100"
                placeholder="MM / YY{if $showccissuestart} ({$LANG.creditcardcardexpires}){/if}" autocomplete="cc-exp">
    ...
    {if $showccissuestart}
        <div class="form-group cc-details{if !$addingNewCard} hidden{/if}">
            ...
            <div class="col-xs-2">
                <input type="number" name="ccissuenum" id="inputIssueNum" value="{$ccissuenum}"
    ...
    <div class="form-group">
        ...
        <div class="col-sm-7">
            <input type="tel" name="cccvv" id="inputCardCvv" value="{$cccvv}" autocomplete="off"
                class="form-control input-inline input-inline-100" />
    ...
    {if $allowClientsToRemoveCards}
        <div class="form-group cc-details{if !$addingNewCard} hidden{/if}">
            <div class="col-sm-offset-4 col-sm-8">
                ...
                <input type="checkbox" class="toggle-switch-success" data-size="mini" checked="checked" name="nostore"
                    id="inputNoStore" value="0" data-on-text="{lang key='yes'}" data-off-text="{lang key='no'}">
    ...
    <div id="inputDescriptionContainer" class="form-group cc-details{if !$addingNewCard} hidden{/if}">
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control" id="inputDescription" name="ccdescription" autocomplete="off" value=""
                placeholder="{lang key='paymentMethods.descriptionInput'} {$LANG.paymentMethodsManage.optional}" />
        </div>
    </div>
{/if}