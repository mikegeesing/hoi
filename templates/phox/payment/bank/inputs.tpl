{if file_exists("templates/$template/packages/overwrites/payment/bank/inputs.tpl")}
    {include file="{$template}/packages/overwrites/payment/bank/inputs.tpl"}
{else}
    <div class="form-group bank-details{if !$addingNew} hidden{/if}">
        ...
        <div class="col-sm-7">
            <label class="radio-inline icheck-label">
                <input type="radio" class="icheck-button" name="account_type" id="inputBankAcctType" value="Checking"
                    {if !$accountType || $accountType == 'Checking'} checked{/if}>
                {lang key='paymentMethodsManage.checking'}
            </label>
            <label class="radio-inline icheck-label">
                <input type="radio" class="icheck-button" name="account_type" value="Savings" {if $accountType == 'Savings'}
                    checked{/if}>
    ...
    <div class="form-group bank-details{if !$addingNew} hidden{/if}">
        ...
        <div class="col-sm-7">
            <input type="text" class="form-control" id="inputBankAcctHolderName" name="account_holder_name"
                autocomplete="off" value="{$accountHolderName}">
    ...
    <div class="form-group bank-details{if !$addingNew} hidden{/if}">
        ...
        <div class="col-sm-7">
            <input type="text" class="form-control" id="inputBankName" name="bank_name" autocomplete="off"
                value="{$bankName}">
            <span class="field-error-msg">
                {lang key='paymentMethods.fieldRequired'}
            </span>
    ...
    <div class="form-group bank-details{if !$addingNew} hidden{/if}">
        ...
        <div class="col-sm-7">
            <input type="tel" class="form-control" id="inputBankRoutingNum" name="routing_number" autocomplete="off"
                value="{$routingNumber}">
            <span class="field-error-msg">
    ...
    <div class="form-group bank-details{if !$addingNew} hidden{/if}">
        ...
        <div class="col-sm-7">
            <input type="tel" class="form-control" id="inputBankAcctNum" name="account_number" autocomplete="off"
                value="{$accountNumber}">
            <span class="field-error-msg">
    ...
    <div id="inputDescriptionContainer" class="form-group bank-details{if !$addingNew} hidden{/if}">
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control" id="inputDescription" name="description" autocomplete="off"
                value="{$description}" placeholder="{lang key='paymentMethodsManage.optional'}">
        </div>
    </div>
