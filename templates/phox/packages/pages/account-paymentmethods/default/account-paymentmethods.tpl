...
<div class="section">
    <div class="section-header">
        <h2 class="section-title">{$LANG.paymentMethods.intro}</h2>
    </div>
...
{include file="$template/includes/tablelist.tpl" tableName="PayMethodList"}

<script type="text/javascript">
jQuery(document).ready(function() {
  var table = jQuery('#tablePayMethodList').removeClass('hidden').DataTable();
  table.draw();
...
<div class="table-container clearfix">
    <table class="table table-list display responsive nowrap hidden" id="tablePayMethodList">
        <thead>
            <tr>
                <th></th>
                ...
                <th>{$LANG.paymentMethods.actions}</th>
            </tr>
        </thead>
