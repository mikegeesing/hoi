                ...
                <div class="row">
                    <div class="secondary-cart-body">
                        ...
                        <div id="serviceRenewals" class="service-renewals">
                            {include file="orderforms/phox/service-renewal-item.tpl" renewableItems=$renewableServices prefix=''}
                        </div>
                    </div>
                    <div class="secondary-cart-sidebar" id="scrollingPanelContainer">
                        <div id="orderSummary">
                            ...
                            <div class="text-center">
                                <a id="btnGoToCart" class="wdes-phox-cart_btn" href="{$WEB_ROOT}/cart.php?a=view">
                                    {lang key='viewcart'}
