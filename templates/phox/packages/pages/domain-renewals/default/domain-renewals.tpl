                                ...
                                <div class="domain-renewal" data-domain="{$renewalData.domain}">
                                    <div class="pull-right float-right">
                                        ...
                                        {elseif !$renewalData.beforeRenewLimit && $renewalData.daysUntilExpiry > 0}
                                            <span
                                                class="label label-{if $renewalData.daysUntilExpiry > 30}success{else}warning{/if}">
                                    ...
                                    <h3 class="wdes-domain-renew-title">{$renewalData.domain}</h3>

                                    <p class="wdes-domain-renew-description">{lang key='clientareadomainexpirydate'}:
                                        {$renewalData.expiryDate->format('j M Y')}
                                    ...
                                    {else}
                                        <form>
                                            <div class="form-group">
                                                <div class="wdes-flex-domain-renew">
                    ...
                    <div class="secondary-cart-sidebar" id="scrollingPanelContainer">
                        ...
                        <div id="orderSummary">
                            <div class="order-summary">
                                ...
                                <div class="text-center">
                                    <a id="btnGoToCart" class="wdes-phox-cart_btn wdes-cart-goto"
