{if file_exists("templates/$template/packages/overwrites/domainchecker-results.tpl")}
    {include file="{$template}/packages/overwrites/domainchecker-results.tpl"}
{else}
    {if $validDomain}
                                    ...
                                    {else}
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-primary btn-sm"
                                                onclick="addToCart(this, false, 'register')">
                                                <b class="glyphicon glyphicon-shopping-cart"></b>
                                                {$LANG.addtocart}
                                            </button>
                                            <button type="button" class="btn btn-primary btn-sm dropdown-toggle additional-options"
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    {elseif $result.isRegistered}
                                        ...
                                        <button type="button" onclick="viewWhois('{$result.domainName}')"
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                        ...
                        <tbody>
                            {foreach $searchResults.suggestions as $i => $result}
                                <tr{if $i >= 10} class="hidden" {/if}>
                                    ...
                                    <td class="text-right">
                                        {if count($result.pricing) == 1}
                                            <button type="button" onclick="addToCart(this, true, 'register')"
                                        ...
                                        {else}
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-default btn-sm"
                                                    onclick="addToCart(this, true, 'register')">
                                                    <b class="glyphicon glyphicon-shopping-cart"></b>
                                                    {$LANG.addtocart}
                                                </button>
                ...
                {if $moreSuggestionsAvailable}
                    <p class="text-center">
                        <a href="#" class="btn btn-link" id="btnMoreSuggestions"
                            onclick="showMoreSuggestions();return false">{$LANG.domainsmoresuggestions}</a>
                    </p>
                {/if}
