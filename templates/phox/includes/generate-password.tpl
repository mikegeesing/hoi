{if file_exists("templates/$template/packages/overwrites/includes/generate-password.tpl")}
    {include file="{$template}/packages/overwrites/includes/generate-password.tpl"}
{else}
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="generatePwLength"
                                class="col-sm-4 control-label">{$LANG.generatePassword.pwLength}</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            <label for="generatePwOutput"
                                class="col-sm-4 control-label">{$LANG.generatePassword.generatedPw}</label>
                            <div class="col-sm-8">
