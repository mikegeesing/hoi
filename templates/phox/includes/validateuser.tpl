{if file_exists("templates/$template/packages/overwrites/includes/validateuser.tpl")}
    {include file="{$template}/packages/overwrites/includes/validateuser.tpl"}
{else}
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-2 col-xs-push-10 col-sm-1 col-sm-push-11">
                        <button id="btnUserValidationClose" type="button" class="btn close"
                            data-uri="{routePath('dismiss-user-validation')}"><span aria-hidden="true">&times;</span></button>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-3 col-sm-pull-1">
                        <a href="#" class="btn btn-default btn-sm btn-block btn-action" data-url="{$userValidationUrl}"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-body top-margin-10">
                        <iframe id="validationContent" allow="camera {$userValidationHost}" width="100%" height="700"
