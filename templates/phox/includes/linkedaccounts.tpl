{if file_exists("templates/$template/packages/overwrites/includes/linkedaccounts.tpl")}
    {include file="{$template}/packages/overwrites/includes/linkedaccounts.tpl"}
{else}
