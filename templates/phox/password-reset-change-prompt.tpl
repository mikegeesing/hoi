{if file_exists("templates/$template/packages/overwrites/password-reset-change-prompt.tpl")}
    {include file="{$template}/packages/overwrites/password-reset-change-prompt.tpl"}
{else}
