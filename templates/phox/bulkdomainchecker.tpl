{if file_exists("templates/$template/packages/overwrites/bulkdomainchecker.tpl")}
    {include file="{$template}/packages/overwrites/bulkdomainchecker.tpl"}
{else}
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 col-xs-10 col-xs-offset-1">
                        <div class="input-group-box">
                            <textarea name="bulkdomains" id="inputBulkDomains" rows="8"
                                class="form-control margin-bottom-5">{$bulkdomains}</textarea>
                            <button type="submit" id="btnCheckAvailability"
                                class="btn btn-primary btn-block">{$LANG.checkavailability}</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="currencychooser pull-right clearfix margin-bottom">
                <div class="btn-group" role="group">
                    {foreach from=$currencies item=curr}
                        <a href="domainchecker.php?search=bulk{if $searchingFor == 'transfer'}transfer{/if}&currency={$curr.id}"
