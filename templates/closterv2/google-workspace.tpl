      ...
      <div class="row align-items-center justify-content-between">
        <div class="col-lg-6">
          <div class="banner-heading">
            ...
            </ul> {if count($googleworkspaceproducts) gt 0 && ($googleworkspaceproducts.0.monthly gt 0 || $googleworkspaceproducts.0.annually gt 0 || $googleworkspaceproducts.0.biennially gt 0 || $googleworkspaceproducts.0.triennially gt 0)} {foreach $googleworkspaceproducts as $productKey => $myproduct} {if $productKey eq 0} <h4>Starting Price {$myproduct.prefix}{$myproduct.monthly}/mo</h4> {/if} {/foreach}{/if} <div class="inline-btns mt-3">
        ...
        <div class="col-lg-5 d-none d-lg-block">
          <div class="text-center text-lg-end">
            <img src="{$WEB_ROOT}/templates/{$template}/custom/assets/images/28.svg" alt="Banner image" width="500">
          </div>
        </div>
      </div>
    </div>
...
<section class="top-up-banner pb-4" id="Plans">
  <div class="container upside rounded bg-white shadow p-4">
    <div class="row gy-4 gy-xl-0 justify-content-between"> {if count($googleworkspaceproducts) gt 0 && ($googleworkspaceproducts.0.monthly gt 0 || $googleworkspaceproducts.0.annually gt 0 || $googleworkspaceproducts.0.biennially gt 0 || $googleworkspaceproducts.0.triennially gt 0)} {foreach $googleworkspaceproducts as $myproduct} <div class="col-lg-5 col-xl-4 col-md-6">
    ...
    <div class="row justify-content-center gy-4">
      <div class="col-lg-4 col-md-6 col-12">
        <div class="services-one">
          ...
          <div class="icon">
            <img src="{$WEB_ROOT}/templates/{$template}/custom/assets/images/website.png" alt="services icon">
          </div>
      ...
      <div class="col-lg-4 col-md-6 col-12">
        <div class="services-one">
          ...
          <div class="icon">
            <img src="{$WEB_ROOT}/templates/{$template}/custom/assets/images/coding.png" alt="services icon">
          </div>
    ...
    <div class="row align-items-center gy-4 gy-lg-0 flex-lg-row-reverse">
      ...
      <div class="col-lg-6">
        <div class="text-center text-lg-start d-block w-100">
          <img src="{$WEB_ROOT}/templates/{$template}/custom/assets/images/performance.svg" alt="Host your website" width="500">
        </div>
      </div>
    </div>
  </div>
...
<section class="section-gap">
  <div class="container">
    ...
    <div class="row align-items-center gy-4 gy-lg-0">
      ...
      <div class="col-lg-6">
        <div class="text-center text-lg-start d-block w-100">
          <img src="{$WEB_ROOT}/templates/{$template}/custom/assets/images/collabration.svg" alt="Host your website" width="500">
        </div>
      </div>
    </div>
  </div>
...
<section class="section-gap">
  <div class="container">
    ...
    <div class="row align-items-center gy-4 gy-lg-0">
      ...
      <div class="col-lg-6">
        <div class="text-center text-lg-start d-block w-100">
          <img src="{$WEB_ROOT}/templates/{$template}/custom/assets/images/manage.svg" alt="Host your website" width="500">
        </div>
      </div>
    </div>
  </div>
