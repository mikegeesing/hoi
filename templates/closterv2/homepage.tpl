      ...
      <div class="row align-items-center justify-content-between">
        ...
        <div class="col-lg-5 d-none d-lg-block">
          <div class="text-center text-lg-end">
            <img src="{$WEB_ROOT}/templates/{$template}/custom/assets/images/1.svg" alt="Banner image">
          </div>
        </div>
      </div>
    </div>
...
<section class="top-up-banner pb-4" id="Plans">
  <div class="container upside rounded bg-white shadow p-4">
    <div class="row gy-4 gy-xl-0 justify-content-between"> {if $sharedhostingproducts|@count gt 0 0 && ($sharedhostingproducts.0.monthly gt 0 || $sharedhostingproducts.0.annually gt 0 || $sharedhostingproducts.0.biennially gt 0 || $sharedhostingproducts.0.triennially gt 0)} {foreach $sharedhostingproducts as $productKey => $myproduct} <div class="col-lg-5 col-xl-4 col-md-6">
    ...
    <div class="row">
      <div class="col-12">
        <div class="text-center">
          <img src="{$WEB_ROOT}/templates/{$template}/custom/assets/images/datacenter_location.png" alt="Data center">
        </div>
      </div>
    </div>
  </div>
