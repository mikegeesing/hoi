      ...
      <div class="row align-items-center justify-content-between">
        <div class="col-lg-6">
          <div class="banner-heading">
            ...
            </ul> {if count($sitelockproducts) gt 0 && ($sitelockproducts.0.monthly gt 0 || $sitelockproducts.0.annually gt 0 || $sitelockproducts.0.biennially gt 0 || $sitelockproducts.0.triennially gt 0)} {foreach $sitelockproducts as $productKey => $myproduct} {if $productKey eq 0} <h4>Starting Price {$myproduct.prefix}{$myproduct.monthly}/mo</h4>{/if} {/foreach}{/if} <div class="inline-btns mt-3">
        ...
        <div class="col-lg-5 d-none d-lg-block">
          <div class="text-center text-lg-end">
            <img src="{$WEB_ROOT}/templates/{$template}/custom/assets/images/31.svg" alt="Banner image" width="500">
          </div>
        </div>
      </div>
    </div>
...
<section class="top-up-banner pb-4" id="Plans">
  <div class="container upside rounded bg-white shadow p-4">
    ...
    <div class="row gy-4 gy-xl-0 justify-content-between"> {if count($sitelockproducts) gt 0 && ($sitelockproducts.0.monthly gt 0 || $sitelockproducts.0.annually gt 0 || $sitelockproducts.0.biennially gt 0 || $sitelockproducts.0.triennially gt 0)} {foreach $sitelockproducts as $productKey => $myproduct} <div class="col-lg-5 col-xl-4 col-md-6">
        ...
        <ul class="feature-list">
          <li class="list-item">
            <div class="feature-img">
              <img src="{$WEB_ROOT}/templates/{$template}/custom/assets/images/viruses.png" alt="features icon">
            </div>
          ...
          <li class="list-item ">
            <div class="feature-img">
              <img src="{$WEB_ROOT}/templates/{$template}/custom/assets/images/hacker.png" alt="features icon">
            </div>
            <div class="feature-content">
              <h3>Hackers</h3>
          ...
          <li class="list-item">
            <div class="feature-img">
              <img src="{$WEB_ROOT}/templates/{$template}/custom/assets/images/block_user.png" alt="features icon">
            </div>
            <div class="feature-content">
