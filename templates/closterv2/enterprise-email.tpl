      ...
      <div class="row align-items-center justify-content-between">
        ...
        <div class="col-lg-5 d-none d-lg-block">
          <div class="text-center text-lg-end">
            <img src="{$WEB_ROOT}/templates/{$template}/custom/assets/images/27.svg" alt="Banner image" width="500">
          </div>
        </div>
      </div>
    </div>
...
<section class="top-up-banner pb-4" id="Plans">
  <div class="container upside rounded bg-white shadow p-4">
    <div class="row gy-4 gy-xl-0 justify-content-between"> {if count($enterpriseemailproducts) gt 0 && ($enterpriseemailproducts.0.monthly gt 0 || $enterpriseemailproducts.0.annually gt 0 || $enterpriseemailproducts.0.biennially gt 0 || $enterpriseemailproducts.0.triennially gt 0)} {foreach $enterpriseemailproducts as $myproduct} <div class="col-lg-5 col-xl-4 col-md-6">
  ...
  <div class="container">
    ...
    <div class="row g-4 gy-lg-5">
      ...
      <div class="col-lg-6">
        <div class="services-two">
          <div class="icon">
            <img src="{$WEB_ROOT}/templates/{$template}/custom/assets/images/storage.png" alt="serices icon">
          </div>
          <div class="content">
      ...
      <div class="col-lg-6">
        <div class="services-two">
          <div class="icon">
            <img src="{$WEB_ROOT}/templates/{$template}/custom/assets/images/website.png" alt="serices icon">
          </div>
          <div class="content">
      ...
      <div class="col-lg-6">
        <div class="services-two">
          <div class="icon">
            <img src="{$WEB_ROOT}/templates/{$template}/custom/assets/images/smart.png" alt="serices icon">
          </div>
          <div class="content">
            <h3>Smart Widgets</h3>
    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-4 col-md-6 col-12">
        <div class="services-one">
          ...
          <div class="icon">
            <img src="{$WEB_ROOT}/templates/{$template}/custom/assets/images/smart.png" alt="services icon">
          </div>
      ...
      <div class="col-lg-4 col-md-6 col-12">
        <div class="services-one">
          ...
          <div class="icon">
            <img src="{$WEB_ROOT}/templates/{$template}/custom/assets/images/storage.png" alt="services icon">
          </div>
