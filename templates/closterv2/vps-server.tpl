      ...
      <div class="row align-items-center justify-content-between">
        ...
        <div class="col-lg-5 d-none d-lg-block">
          <div class="text-center text-lg-end">
            <img src="{$WEB_ROOT}/templates/{$template}/custom/assets/images/18.svg" alt="Banner image" width="500">
          </div>
        </div>
      </div>
    </div>
...
<section class="top-up-banner pb-4" id="Plans">
  <div class="container upside rounded bg-white shadow p-4">
    ...
    <div class="row gy-4 gy-xl-0 justify-content-between"> {if count($vpsproducts) gt 0 && ($vpsproducts.0.monthly gt 0 || $vpsproducts.0.annually gt 0 || $vpsproducts.0.biennially gt 0 || $vpsproducts.0.triennially gt 0)} {foreach $vpsproducts as $myproduct} <div class="col-lg-4 col-xl-3 col-md-6">
        <div class="pricing-item">
          <div class="pricing-heading">
            <div class="name">{$myproduct.name} </div>
            <div class="monthly-price">
              <h4 class="title "> {$myproduct.prefix}{$myproduct.monthly} <span class="durection">/mo</span>
              </h4>
            </div>
            <div class="yearly-price">
              <h4 class="title "> {$myproduct.prefix}{$myproduct.annually} <span class="durection">/Yr</span>
              </h4>
            </div>
            <div class="biannual-price">
              <h4 class="title "> {$myproduct.prefix}{$myproduct.biennially} <span class="durection">/2 Yr</span>
              </h4>
            </div>
            <div class="triennial-price">
              <h4 class="title "> {$myproduct.prefix}{$myproduct.triennially} <span class="durection">/3 Yr</span>
              </h4>
            </div>
          </div>
        ...
        <div class="col-12">
          <div class="big-screen-tab six-coloumn">
            <button class="tabing-buttons active" data-target="tab1">
              <img src="{$WEB_ROOT}/templates/{$template}/custom/assets/images/tools.png" alt="img">Deploy </button>
            <button class="tabing-buttons" data-target="tab2">
              <img src="{$WEB_ROOT}/templates/{$template}/custom/assets/images/storage.png" alt="img">Additional Storage </button>
            <button class="tabing-buttons" data-target="tab3">
              <img src="{$WEB_ROOT}/templates/{$template}/custom/assets/images/website.png" alt="img"> Manage </button>
            <button class="tabing-buttons" data-target="tab4">
              <img src="{$WEB_ROOT}/templates/{$template}/custom/assets/images/internet.png" alt="img">Secure </button>
            <button class="tabing-buttons" data-target="tab5">
              <img src="{$WEB_ROOT}/templates/{$template}/custom/assets/images/helpdesk.png" alt="img">Get Support </button>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="row align-items-center gy-4 gy-lg-0 justify-content-between">
            ...
            <div class="col-lg-5 d-none d-lg-block">
              <div class="text-center">
                <img src="{$WEB_ROOT}/templates/{$template}/custom/assets/images/19.svg" alt="images" width="350">
              </div>
            </div>
          </div>
        </div>
