...
<div class="banner-one">
        ...
        <div class="row align-items-center justify-content-between">
          ...
          <div class="col-lg-5 d-none d-lg-block">
            <div class="text-center text-lg-end">
              <img src="{$WEB_ROOT}/templates/{$template}/custom/assets/images/20.svg" alt="Banner image" width="400">
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="top-up-banner pb-4" id="Plans">
    <div class="container upside rounded bg-white shadow p-4">
      ...
      <div class="row gy-4 gy-lg-0"> {if count($dedicatedproducts) gt 0 && ($dedicatedproducts.0.monthly gt 0 || $dedicatedproducts.0.annually gt 0 || $dedicatedproducts.0.biennially gt 0 || $dedicatedproducts.0.triennially gt 0)} {foreach $dedicatedproducts as $myproduct} <div class="col-lg-4 col-md-6">
      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-4 col-md-6 col-12">
          <div class="services-one">
            ...
            <div class="icon">
              <img src="{$WEB_ROOT}/templates/{$template}/custom/assets/images/server.png" alt="services icon">
            </div>
