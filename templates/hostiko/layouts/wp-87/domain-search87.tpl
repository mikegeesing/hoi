        ...
        <form method="post" action="domainchecker.php" id="frmDomainHomepage">
            <input type="hidden" name="token" value="b0037d84a01aab66eb3c8ef872ec296b3eebe05f">
                <div class="home-domain-search bg-white">
                    <div class="container">
                        <div class="p-5 clearfix position-relative">
                                        ...
                                        <button type="submit" id="btnTransfer2" data-domain-action="transfer" class="btn btn-success btn-block">
                                            Transfer
                                                 ...
                                                 <ul class="tld-logos">
                                                    ...
                                                    <li>
                                                        <div class="image">
                                                            <img src="{$WEB_ROOT}/templates/{$template}/layouts/wp-{$layoutnotset}/assets/images/uk.png">
                                                        </div>
                                                        <span>$5.99/yr</span>       
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <div class="image">
                                                        <img src="{$WEB_ROOT}/templates/{$template}/layouts/wp-{$layoutnotset}/assets/images/asia.png">
                                                        </div>
                                                        <span>$13.99/yr</span>                                                                                        
                                                    </li>
                                                    <li>
