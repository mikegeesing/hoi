                            ...
                            <div class="row d-sm-none">
                                    ...
                                    <div class="domain-icons">
                                        <ul class="tld-logos">
                                            ...
                                            <li class="box">
                                                <span class="heading heading3"><span class="dot dot3">.</span>aws</span>
                                            </li>
                                            <li class="box">
                                                <span class="heading heading4"><span class="dot dot4">.</span>app</span>
                                            </li>
                                            <li class="box">
                                                <span class="heading heading4"><span class="dot dot4">.</span>net</span>
                                            </li>
                                        </ul>
