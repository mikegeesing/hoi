                                    ...
                                    <ul class="tld-logos">
                                                    <li>
                                                     <img src="{$WEB_ROOT}/templates/{$template}/layouts/wp-{$layoutnotset}/assets/images/com.png">
                                                            <span class="value">$30/Yr</span> 
                                                    </li>
                                                    <li>
                                                          <img src="{$WEB_ROOT}/templates/{$template}/layouts/wp-{$layoutnotset}/assets/images/co.png">
                                                             <span class="value">$27/Yr</span> 
                                                    </li>
                                                    <li> 
                                                           <img src="{$WEB_ROOT}/templates/{$template}/layouts/wp-{$layoutnotset}/assets/images/ca.png">
                                                           <span class="value">$19/Yr</span> 
                                                    </li>
                                                    <li>
                                                           <img src="{$WEB_ROOT}/templates/{$template}/layouts/wp-{$layoutnotset}/assets/images/org.png">
                                                            <span class="value">$32/Yr</span> 
                                                    </li>
                                                    <li>
