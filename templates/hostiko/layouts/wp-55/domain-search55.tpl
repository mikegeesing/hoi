                        ...
                        <div class="p-5 clearfix">
                            ...
                            <div class="row d-sm-none">
                                        ...
                                        <button type="submit" id="btnTransfer2" data-domain-action="transfer" class="btn btn-success btn-block">
                                            ...
                                            <ul class="tld-logos">
                                                <li class="box">
                                                    <span class="heading"><span class="dot dot1">.</span>com</span>
                                                    <span class="number">$9.99</span>
                                                </li>
                                                <li class="box">
                                                    <span class="heading"><span class="dot dot2">.</span>net</span>
                                                    <span class="number">$5.99</span>
                                                </li>
                                                <li class="box">
                                                    <span class="heading"><span class="dot dot3">.</span>online</span>
                                                    <span class="number">$7.99</span>
                                                </li>
                                                <li class="box">
                                                    <span class="heading font-italic"><span class="dot dot4">.</span>tech</span>
                                                    <span class="number">$11.99</span>
                                                </li>
                                            </ul>
