                                        ...
                                        <button type="submit" id="btnTransfer2" data-domain-action="transfer" class="btn btn-success btn-block">
                                            ...
                                            <ul class="tld-logos">
                                                <li class="box1">
                                                    ...
                                                    <span class="number">$2.99/year</span>
                                                </li>
                                                <li class="box2">
                                                    <img src="{$WEB_ROOT}/templates/{$template}/layouts/wp-{$layoutnotset}/assets/images/net.png">  
                                                    <span class="number">$4.99/year</span>
                                                </li>
                                                <li class="box3">
                                                    <img src="{$WEB_ROOT}/templates/{$template}/layouts/wp-{$layoutnotset}/assets/images/eu.png">  
                                                    <span class="number">$5.75/year</span>
                                                </li>
                                                <li class="box4">
                                                    <img src="{$WEB_ROOT}/templates/{$template}/layouts/wp-{$layoutnotset}/assets/images/us.png">  
                                                    <span class="number">$7.49/year</span>
                                                </li>
                                            </ul>
