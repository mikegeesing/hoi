                ...
                <div class="home-domain-search bg-white">
                    <div class="container">
                        <div class="py-5 clearfix">
                            ...
                            <div class="row d-sm-none">
                                        ...
                                        <button type="submit" id="btnTransfer2" data-domain-action="transfer" class="btn btn-success btn-block">
                                           <i class="fas fa-random"></i> Transfer
                                                ...
                                                <span class="d-inline-block populr-domain">Popular Domain:</span>
                                    <ul class="tld-logos">
                                                    <li>
                            ...
                            <a href="{$WEB_ROOT}/index.php?rp=/domain/pricing" class="btn btn-link btn-sm float-right">View all pricing</a></div>
                        </div>
                    </div>
                </div>
        </form>
