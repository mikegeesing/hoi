                            ...
                            <div class="row d-sm-none">
                                        ...
                                        <button type="submit" id="btnTransfer2" data-domain-action="transfer" class="btn btn-success btn-block">
                                            ...
                                            <ul class="tld-logos">
                                                ...
                                                <li>
                                                    <div class="value">
                                                        <img class="store-image" src="{$WEB_ROOT}/templates/{$template}/layouts/wp-{$layoutnotset}/assets/images/store.png">
                                                        <span> $18.99 </span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="value">
                                                        <img class="co-image" src="{$WEB_ROOT}/templates/{$template}/layouts/wp-{$layoutnotset}/assets/images/co.png">
                                                        <span> $19.99 </span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="value">
                                                        <img class="org-image" src="{$WEB_ROOT}/templates/{$template}/layouts/wp-{$layoutnotset}/assets/images/org.png">
                                                        <span> $21.99 </span>
                                                    </div>
                                                </li>
                                            </ul>
                            
                            <a href="{$WEB_ROOT}/index.php?rp=/domain/pricing" class="btn btn-link btn-sm float-right">View all pricing<i class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
        </form>
