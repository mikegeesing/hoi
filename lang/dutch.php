...
$_LANG['store']['nordvpn']['features']['comparison']['asterisk'] = "*Algehele netwerkprestaties volgens onderzoek van AV-Test. Je kunt :tagOpenhet volledige rapport:tagClose lezen. Vergelijkingsdatum: 17 februari 2021.";
...
$_LANG['store']['nordvpn']['features']['comparison']['wireguard'] = "WireGuard&reg; voor topsnelheden";
...
$_LANG['store']['nordvpn']['features']['security']['tagline2'] = ":tagOpenGebruik NordVPN om uw online activiteiten te versleutelen:tagClose voor een extra beschermingslaag, waar en wanneer u bent verbonden.";
...
$_LANG['store']['nordvpn']['features']['threat']['malware'] = "Wanneer u bestanden downloadt, controleert :tagOpenThreat Protection:tagClose deze op malware.";
$_LANG['store']['nordvpn']['features']['threat']['protection'] = ":tagOpenThreat Protection:tagClose blokkeert opdringerige advertenties en webtrackers, scant URL's automatisch en blokkeert schadelijke URL's.";
$_LANG['store']['nordvpn']['features']['threat']['safe'] = ":tagOpenThreat Protection:tagClose beschermt niet alleen uw apparaten, maar ook u! De mogelijkheid om trackers te blokkeren helpt u om online spionnen en stalkers te vermijden.";
$_LANG['store']['nordvpn']['features']['threat']['tagline'] = "De :tagOpenThreat Protection:tagClose-functie van NordVPN is een gamechanger die nog meer veiligheidsvoordelen en betere bescherming biedt met maar één extra klik.";
$_LANG['store']['nordvpn']['features']['threat']['title'] = "Meer dan een VPN";
$_LANG['store']['nordvpn']['features']['use']['tagline1'] = "Ook wie niets heeft te verbergen, zit er waarschijnlijk niet op te wachten om te worden begluurd en gevolgd. De belangrijkste reden waarom internetgebruikers voor een VPN kiezen, is online privacy en veiligheid in het algemeen.:tagBreak:tagOpenMaar WAAROM precies?:tagClose";
...
$_LANG['store']['nordvpn']['hero']['tagline'] = "Beveilig uw verbinding en verberg uw IP-adres.:tagBreakBlokkeer malware, trackers en advertenties.";
