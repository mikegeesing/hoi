<?php
/* Smarty version 3.1.48, created on 2025-10-28 21:55:56
  from '/home/onlineh/domains/onlinehoster.nl/public_html/templates/orderforms/Redcheap_Professional/checkout.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.48',
  'unifunc' => 'content_69012ddc579f13_84343611',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '51d2afae1fab35186ccc49ce56e6a94105306240' => 
    array (
      0 => '/home/onlineh/domains/onlinehoster.nl/public_html/templates/orderforms/Redcheap_Professional/checkout.tpl',
      1 => 1761561844,
      2 => 'file',
    ),
  ),
  ...
  array (
    ...
    'file:orderforms/Redcheap_Professional/linkedaccounts.tpl' => 2,
    'file:orderforms/Redcheap_Professional/includes/existing-paymethods.tpl' => 1,
    'file:orderforms/Redcheap_Professional/recommendations-modal.tpl' => 1,
  ),
),false)) {
function content_69012ddc579f13_84343611 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
>
...
<?php echo '</script'; ?>
>
<?php $_smarty_tpl->_subTemplateRender("file:orderforms/Redcheap_Professional/common.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
echo '<script'; ?>
...
?>
        ...
        <div class="cart-body">
            ...
            <div class="header-lined">
                <h2 class="font-size-22"><?php echo $_smarty_tpl->tpl_vars['LANG']->value['orderForm']['checkout'];?>
</h2>
            </div>
...
?>
            ...
            <div class="already-registered d-flex align-items-center justify-content-lg-between">
                <p class="text-sm-left overflow-hidden mb-0"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['lang'][0], array( array('key'=>'orderForm.enterPersonalDetails'),$_smarty_tpl ) );?>
</p>
...
">
                    ...
                    <?php $_smarty_tpl->_subTemplateRender("file:orderforms/Redcheap_Professional/linkedaccounts.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('linkContext'=>"checkout-existing"), 0, false);
?>
                </div>

                <div id="containerNewUserSignup"
                    <?php if ($_smarty_tpl->tpl_vars['custtype']->value === 'existing' || (is_numeric($_smarty_tpl->tpl_vars['selectedAccountId']->value) && $_smarty_tpl->tpl_vars['selectedAccountId']->value > 0) || ($_smarty_tpl->tpl_vars['loggedin']->value && $_smarty_tpl->tpl_vars['selectedAccountId']->value !== 'new' && $_smarty_tpl->tpl_vars['custtype']->value !== 'add')) {?>
                        class="w-hidden"
                    <?php }?>
                >

                    <div<?php if ($_smarty_tpl->tpl_vars['loggedin']->value) {?> class="w-hidden"<?php }?>>
                        <?php $_smarty_tpl->_subTemplateRender("file:orderforms/Redcheap_Professional/linkedaccounts.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('linkContext'=>"checkout-new"), 0, true);
?>
                    </div>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                ...
                <?php if ($_smarty_tpl->tpl_vars['captcha']->value && $_smarty_tpl->tpl_vars['captcha']->value->isEnabled() && $_smarty_tpl->tpl_vars['captcha']->value->isEnabledForForm($_smarty_tpl->tpl_vars['captchaForm']->value)) {?>
                    <?php if (!$_smarty_tpl->tpl_vars['captcha']->value->isInvisible()) {?>
                        <div class="sub-heading">
                            <span class="primary-bg-color"><?php echo $_smarty_tpl->tpl_vars['LANG']->value['captchatitle'];?>
</span>
                        </div>
                    <?php }?>
                    <div class="text-center">
...
: &nbsp; <strong id="totalCartPrice" class="h6 font-weight-bold"><?php echo $_smarty_tpl->tpl_vars['total']->value;?>
</strong>
                </div>
...
">
                ...
                <?php if (!$_smarty_tpl->tpl_vars['inExpressCheckout']->value) {?>
                    <div id="paymentGatewaysContainer" class="form-group tt-payment-container">
                        <h6><?php echo $_smarty_tpl->tpl_vars['LANG']->value['orderForm']['preferredPaymentMethod'];?>
</h6>
                    ...
                    <div class="cc-input-container<?php if ($_smarty_tpl->tpl_vars['selectedgatewaytype']->value != "CC") {?> w-hidden<?php }?>" id="creditCardInputFields">
                        <?php if ($_smarty_tpl->tpl_vars['client']->value) {?>
                            <div id="existingCardsContainer" class="existing-cc-grid">
                                <?php $_smarty_tpl->_subTemplateRender("file:orderforms/Redcheap_Professional/includes/existing-paymethods.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
                            </div>
                        <?php }?>
...
?>
                    ...
                    <button type="submit"
                            id="btnCompleteOrder"
                            class="mt-3 btn btn-primary btn-lg disable-on-click spinner-on-click<?php if ($_smarty_tpl->tpl_vars['captcha']->value) {
