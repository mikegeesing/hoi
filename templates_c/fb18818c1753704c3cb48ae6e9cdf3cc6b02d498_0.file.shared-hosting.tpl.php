<?php
/* Smarty version 3.1.48, created on 2025-10-27 11:52:11
  from '/home/onlineh/domains/onlinehoster.nl/public_html/whmcs/templates/closterv2/shared-hosting.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.48',
  'unifunc' => 'content_68ff4edb2079a5_19735313',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'fb18818c1753704c3cb48ae6e9cdf3cc6b02d498' => 
    array (
      0 => '/home/onlineh/domains/onlinehoster.nl/public_html/whmcs/templates/closterv2/shared-hosting.tpl',
      1 => 1761562322,
      2 => 'file',
    ),
  ),
...
function content_68ff4edb2079a5_19735313 (Smarty_Internal_Template $_smarty_tpl) {
?><!-- banner start -->
        ...
        <div class="col-12">
          <div class="big-screen-tab six-coloumn">
            <button class="tabing-buttons active" data-target="tab1">
              <img src="<?php echo $_smarty_tpl->tpl_vars['WEB_ROOT']->value;?>
/templates/<?php echo $_smarty_tpl->tpl_vars['template']->value;?>
/custom/assets/images/tools.png" alt="img">Free Cpanel </button>
...
/custom/assets/images/server.png" alt="img">Build in PHP/MySQL </button>
    ...
    <div class="mob-screen-tabs px-lg-5">
      <div class="items">
        <button class="tabing-buttons active" data-target="tab1">Shared Web Hosting with Free cPanel</button>
        <div class="tabing-contents active" id="tab1">
          <div class="row align-items-center gy-4 gy-lg-0 justify-content-between">
            <div class="col-lg-6">
              <div class="section-head">
                <h2 class="d-none d-lg-block">Shared Web Hosting with Free cPanel</h2>
                <p class="mb-3 mb-lg-0 text-start">All Linux Shared Hosting Plans come with cPanel, to make hosting easy for everyone. Setting-up addon domains, Emails, FTP and Databases is convenient with our FREE cPanel.</p>
              </div>
            </div>
            <div class="col-lg-5 d-none d-lg-block">
