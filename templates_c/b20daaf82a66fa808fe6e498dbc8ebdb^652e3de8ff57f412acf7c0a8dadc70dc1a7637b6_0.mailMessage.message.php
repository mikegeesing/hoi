...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.48',
  'unifunc' => 'content_6901315bdd42a9_69114347',
...
function content_6901315bdd42a9_69114347 (Smarty_Internal_Template $_smarty_tpl) {
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateHeader">
                                        <tr>
                                            <td valign="top" class="headerContent">
                                                <img src="https://onlinehoster.nl/assets/images/logo.png" style="max-width:600px;padding:20px 20px 0 20px" id="headerImage" alt="OnlineHoster" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateFooter">
                                        <tr>
                                            <td valign="top" class="footerContent">
                                                ...
                                                &nbsp;<a href="https://onlinehoster.nl/">https://onlinehoster.nl/</a>
                                                <span class="hide-mobile"> | </span>
                                                <a href="https://onlinehoster.nl/admin/">log in to the admin area</a>&nbsp;
                                            </td>
                                        </tr>
                                    </table>
                                </td>
